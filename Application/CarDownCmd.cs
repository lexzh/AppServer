namespace CarDownCmd
{
    ...
    public class CarDownCmd
    {
        ...
        public long icar_SendIOCommand(int int_0, int int_1, string string_1, CmdParam.IodeviceType iodeviceType_0, ref object object_0)
        {
            return (long) this.carFunc.icar_SendIOCommand(this.CalOrderId(int_0, int_1), string_1, (int) iodeviceType_0, ref object_0);
        }

        public long icar_SendRawPackage(int int_0, int int_1, string string_1, CmdParam.CmdCode cmdCode_0, ref object object_0, CmdParam.CommMode commMode_0)
        {
            return (long) this.carFunc.icar_SendRawPackage(this.CalOrderId(int_0, int_1), string_1, (int) cmdCode_0, ref object_0, (int) commMode_0);
        }
